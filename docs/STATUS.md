...
| <a id="Q40"></a>Q40 | Project website on GitHub Pages | `docs` `infra` | 🚫 | M | Site + workflow merged (#66); deploy blocked — private repos get no Pages on this plan. Unblocks at Q42's ops step (flip public, enable Pages), then re-run website.yml. v2: OG image, custom domain. |
