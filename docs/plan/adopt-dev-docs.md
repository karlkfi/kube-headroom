# Plan: Port development-process docs (Q11)

Adopt a set of lightweight development-process docs, scaled to a solo project.
One tracked item; each bullet below is a short doc under `docs/development/`
(create `README.md` to index them).
